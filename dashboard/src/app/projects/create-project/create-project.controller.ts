...
export class CreateProjectController {
  ...
  resolveProjectType(workspaceId: string, projectName: string, projectData: any, deferred: ng.IDeferred<any>): void {
    ...
    projectService.resolveProjectType(copyProjectData, projectTypeService.getProjectTypesIDs()).then(() => {
      deferred.resolve();
    }, (error: any) => {
